...
`Chromium policies.json` is a hardened policy file for Chromium-based browsers, built to maximise security and privacy, strip telemetry, and tighten the attack surface — with the goal of preserving usability wherever possible (though some breakage is expected).
...
- **Google & AI features —** Gemini, built-in AI APIs, Help Me Write, Tab Compare, AI-powered history search, live translation, shopping list, and related features that phone home are disabled or restricted;
